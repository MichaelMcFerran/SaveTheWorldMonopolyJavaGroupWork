...
class PlayerTesting {
	...
	int balance, balanceInvalid, balanceInvalidUpper, currentPosition, currentPositionInvalidUpper,
	...
	void testPlayerConstructorArgsInvalid() {
		...
		// invalid balance
		assertThrows(IllegalArgumentException.class, () -> {
			Player player1 = new Player(name, balanceInvalid, currentPosition);
		});

//		// invalid position, doesn't work due to how current and last position interact
//		assertThrows(IllegalArgumentException.class, () -> {
//			Player player1 = new Player(name, balance, currentPositionInvalidLower);
//		});
	...
	void testInvalidBalance() {
		...
		assertThrows(IllegalArgumentException.class, () -> {
			player1.setBalance(balanceInvalid);
		});
