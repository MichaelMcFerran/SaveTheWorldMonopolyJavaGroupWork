...
public class Tester {
	...
	public static void runGame() {
		...
		for(int i = 0; i < playerList.length; i++) {
			TurnOptions(playerList, playerList[i], scanner);
	 ...
	 * @return boolean
	 */
	public static void TurnOptions(Player[] players, Player player, Scanner scanner) {
		//data used
		boolean validInput = false;
		String response;
		
		System.out.println();
		System.out.println("it's " + player.getName()+"', go!");
		do {
			...
			case "4": endGame(players); break;
			default: System.out.println("You've entered an invalid response!");
					System.out.println("Make sure you enter a value in the given range");
			}
	...
	/**
	 * endgame method, that at the choice of a player ending the game, will display the 
	 * end game scores in descending order (from highest currency to lowest)
	 * @param players
	 */
